...
| 7 | Radical small base | Prefer Linux + multicall core (BusyBox-class) over a trimmed consumer distro. Real system libc. Optimize and measure real work. |
...
| 18 | Runtime ABI | Executable/lib formats, linkers, loaders, system libc, debug symbols—designed for CRIU. |
