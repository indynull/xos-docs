...
| Base system | Multicall core, btrfs layout, images, layers, system libc, hardware profiles / kernel knobs, CRIU kernel path |
| Runtime ABI | Formats, linkers, loaders, debug symbols, dump-friendly layouts |
