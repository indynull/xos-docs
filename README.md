...
**Spine (product shape):** Wayland + modal shell (CLI + plain language; Archy/Enso-informed) · agents as user + unit + ACLs + durable data · CRIU (process) + btrfs (data) · radical small hardware-aware base (multicall + optional Cosmopolitan/APE). QEMU is CI smoke, not the story.
