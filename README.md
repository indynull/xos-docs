...
**Spine (product shape):** Goal-first surface (not just a DE fork) · agents as user + unit + ACLs + durable data · kernel-deep first-class CRIU + btrfs · hardware profiles · near-stock system libc + formats/linkers/loaders/debug · multicall core. QEMU is CI smoke, not the story.
...
| Product | [product/DECISION.md](./product/DECISION.md) · [product/V1_SCOPE.md](./product/V1_SCOPE.md) · [product/SUCCESS_CRITERIA.md](./product/SUCCESS_CRITERIA.md) · [product/TECHNICAL_SHAPE.md](./product/TECHNICAL_SHAPE.md) · [product/OS_VS_DE.md](./product/OS_VS_DE.md) · [product/HARDWARE_PROFILES.md](./product/HARDWARE_PROFILES.md) · [product/LINKERS_LOADERS.md](./product/LINKERS_LOADERS.md) · [product/SECURITY.md](./product/SECURITY.md) · [product/GOVERNANCE.md](./product/GOVERNANCE.md) |
